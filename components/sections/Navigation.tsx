...
const Navigation = () => {
  return (
    <nav className='my-5 w-[50%] max-sm:w-full mx-auto bg-gray-50/50 shadow-[inset_0_1px_2px_rgba(0,0,0,0.06)] text-[#444] max-w-lg flex justify-between item-center py-3 px-4 rounded-full cursor-pointer'>
        <div className='flex gap-2 justify-around items-center px-2 border-r-zinc-800/10 border-r'>
            <span>Home</span> <span><House /></span>
        </div>
