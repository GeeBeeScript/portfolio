    ...
    <footer className="relative w-full border border-zinc-950/10 my-5 py-5 px-4">
      <div className="flex flex-col justify-between items-start gap-15">
        ...
        <div className="flex space-x-3 w-full flex-wrap font-hanken">
          <div className="flex gap-2 justify-center items-center my-3 bg-green-200 px-4 py-2 rounded-4xl font-semibold text-green-600 ">
            <span>
              <Dot size={15} className="w-4 h-4 stroke-9 p-0 m-0 block" />
            </span>{" "}
            <span>Available for Freelance</span>
          </div>
          <div className="flex flex-wrap gap-2 justify-center items-center my-3 bg-purple-200 px-4 py-2 rounded-4xl font-semibold text-purple-600">
            <span>
              <Mail />
            </span>
            <span>engrmitchel@gmail.com</span>
          </div>
          <div className="flex gap-2 justify-center items-center my-3 bg-zinc-950/30 px-4 py-2 rounded-4xl font-semibold text-bg-zinc-950">
            <span>
              <Image
                src="/resources/x.svg"
                alt="Another text"
          ...
          <div className="flex gap-2 justify-center items-center my-3 bg-blue-200 px-4 py-2 rounded-4xl font-semibold text-blue-600">
            <span>
              <Image
